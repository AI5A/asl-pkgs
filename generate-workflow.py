...
ARTIFACTS = [
    ...
    ('AI5A/asl', 'fixes', 'asl-bullseye-x86_64'),
    ('AI5A/asl', 'fixes', 'asl-buster-x86_64'),
    ('AI5A/asl', 'fixes', 'asl-bullseye-armv7l'),
    ('AI5A/asl-update-node-list', 'fixes', 'asl-update-node-list-bullseye-x86_64'),
    ('AI5A/asl-update-node-list', 'fixes', 'asl-update-node-list-buster-x86_64'),
    ('AI5A/asl-update-node-list', 'fixes', 'asl-update-node-list-bullseye-armv7l'),
]
PKGS = ["asl-dahdi", "asl", "asl-update-node-list"]

debian_versions = set(x[2].split('-')[-2] for x in ARTIFACTS)
arch_map = {
    'x86_64': 'amd64',
    'armv7l': 'armhf',
}
